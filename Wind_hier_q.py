...
# model | data
from model.ST_htqf_hier.hier import hier_Autoformer, hier_Crossformer_Freq, hier_LSTM, \
    hier_Crossformer, hier_TCN, hier_GRU, hier_Informer
...
model_dict = {
            'Autoformer': hier_Autoformer,
            'Crossformer': hier_Crossformer,
            'Informer': hier_Informer,
            "GRU": hier_GRU,
            'TCN': hier_TCN,
            'LSTM': hier_LSTM,
            'Crossformer_freq': hier_Crossformer_Freq
        }
