...
from model.must.Informer.encoder import Encoder, EncoderLayer, ConvLayer, EncoderStack
from model.must.Informer.decoder import Decoder, DecoderLayer
from model.must.Informer.attn import FullAttention, ProbAttention, AttentionLayer
from model.must.Informer.embed import DataEmbedding
...
class _Model_Q50(nn.Module):
    def __init__(self,arg,distil=True,mix=True,attn='prob'):
        ...
        self.final_layer = nn.Sequential(nn.Linear(arg.enc_in, self.d_model), nn.GELU(),
