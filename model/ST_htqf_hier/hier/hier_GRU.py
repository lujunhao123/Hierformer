...
from model.ST_htqf_hier.Timenet.GRU import _Model_Q50
...
class Model(nn.Module):
    ...
    def forward(self,seq_x, seq_x_mark, dec_y, seq_x_y_mark,tau,tau_norm, matrix_S,dataset,matrix_G):
        pred_out = self.GRU(seq_x, seq_x_mark, dec_y, seq_x_y_mark,tau,tau_norm, matrix_S,dataset)
