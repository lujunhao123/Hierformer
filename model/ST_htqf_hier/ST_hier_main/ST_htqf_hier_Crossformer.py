...
from model.ST_htqf_hier.Crossformer.Crossformer import _Model_Q50
...
class Model(nn.Module):
    def __init__(self,config):
        ...
        self.Crossformer = _Model_Q50(config)
    ...
    def forward(self,seq_x, seq_x_mark, dec_y, seq_x_y_mark,tau,tau_norm, matrix_S,dataset,matrix_G):
        ...
        pred_out = self.Crossformer(seq_x, seq_x_mark, dec_y, seq_x_y_mark,tau,tau_norm, matrix_S,dataset)
