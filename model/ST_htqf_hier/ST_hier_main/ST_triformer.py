...
from model.ST_htqf_hier.Graph_Freq.triformer import Triformer
...
class Model(nn.Module):
    def __init__(self,config):
        ...
        self.Triformer = Triformer(config)
    ...
    def forward(self,seq_x, seq_x_mark, dec_y, seq_x_y_mark,tau,tau_norm, matrix_S,dataset,matrix_G):
        ...
        pred_out = self.Triformer(seq_x, seq_x_mark, dec_y, seq_x_y_mark,tau,tau_norm, matrix_S,dataset)
